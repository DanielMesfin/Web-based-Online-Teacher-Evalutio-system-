...
<body class="main">
 <div>
    ...
    <h2 class="header">INSTRUCTORS’ PERFORMANCE EVALUATION CHECKLIST FILLED<br/> BY SCHOOL/ DEPARTMENT HEADS</h2>
...
<div class="profile">
 ...
 <div class="admin_info">
  ...
  <table border="3" class="table">
    <caption class="caption"> 
        <form action="" method="post"  class="table-form">
            <label for="#">Name of Instructor: <input type="text" maxlength="80"   id="name" readonly value="<?php echo $fname; ?>"></label>
            <label for="#">  College: <input type="text" maxlength="30" id="college" readonly value="<?php echo $college; ?>"></label>
            <label for="#">School/ Department: <input type="text" maxlength="30"  id="dept" readonly value="<?php echo $dept; ?>"></label> <br><br>
            <label for="#">Academic Year: <input type="text"  maxlength="30" id="year" readonly value="<?php echo $ac_yr; ?>"></label>
      ...
      <form action="teacherResult(head).php" method="post" class="form">
    ...
    <div class="last_form">
            ...
            <br><br><br>
            <input class="btn" type="submit" name="saveData" value="SUBMIT" formnovalidate> 
  ...
  <form action="../php/operation.php" method="POST" class="form_change_p" id="popup">
      ...
      <div>
         <input type="submit"  name="change_pwd_H" class="btn-submit" value="Save"  id="submit"/> 
         <input type="button"  name="change_pwd_H" class="btn-submit exit" value="Exit"  id="exit"/>
     </div>
      </div>
  </form>
<!-- ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// -->
