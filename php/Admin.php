      ...
      <ul class="navbar-nav">
        <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle dropdown-item-text" href="#" id="navbarDarkDropdownMenuLink" role="button" data-bs-toggle="dropdown" aria-expanded="false">
            Task List For Admin  The System 
          </a>
          <ul class="dropdown-menu dropdown-menu-dark" aria-labelledby="navbarDarkDropdownMenuLink">
            <button type="button" class="btn btn-primary btn-lg" data-bs-toggle="modal" data-bs-target="#addStudent">Add Student</button>
              ...
              <button type="button" class="btn btn-primary container-fluid" data-bs-toggle="modal" data-bs-target="#exampleModal">Add Head</button>
              ...
              <button type="button" class="btn btn-primary container-fluid" data-bs-toggle="modal" data-bs-target="#veiwStudent">View Head</button>
            <!--looking grate-->
...
<div class="contaner ml-150 ml-159 gy=10">
 <br><br> <button type="button" class="btn btn-primary container-fluid" data-bs-toggle="modal" data-bs-target="#addStudent">Add Student</button>
 <hr><button type="button" class="btn btn-primary container-fluid" data-bs-toggle="modal" data-bs-target="#addHead">Add Head</button>
 <hr><button type="button" class="btn btn-primary container-fluid" data-bs-toggle="modal" data-bs-target="#addTeacher">Add Teacher </button>
 <hr><button type="button" class="btn btn-primary container-fluid" data-bs-toggle="modal" data-bs-target="#veiwStudent">View Head</button>
</div>
<!-- Modal view Head -->
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel"><h1 .text-center>The List of Head Added </h1></h5>
...
<div class="modal fade" id="addStudent" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <form action="Add_User.php" method="post" class="form-contral row g-3 needs-validation" novalidate>
          <div class="input gy-10">
            ...
            <div class="modal-footer bg-dark">
              <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
              <button type="submit" class="btn btn-primary" name="st_submit" id="liveToastBtn">Save changes</button>
            </div>
          </form>
        </div>
      </div>
  ...
  <!--for input taking for teachers-->
  <div class="modal fade" id="addTeacher" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header text-center bg-dark ">
          <h1 class="modal-title text-light" id="exampleModalLabel" > Fill Student's Information </h1>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <div class="modal-body ml=40px">
          <form action="Add_User.php" method="post" class="form-contral row g-3 needs-validation" novalidate>
    ...
    <div class="modal fade" id="addHead" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          <div class="modal-header text-center bg-dark ">
            <h1 class="modal-title text-light" id="exampleModalLabel" > Fill Department Head's Information </h1>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
          </div>
          <div class="modal-body ml=40px">
            <form action="Add_User.php" method="post" class="form-contral row g-3 needs-validation" novalidate>
